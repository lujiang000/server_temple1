...
fun_create(){
    ...
    cp  -f ../output/all_pb.beam  ../../ebin
    cp  -f ../output/all_pb.hrl  ../../include
    echo proto复制完成
}
...
fun_sync_proto() {
    cd $ROOT/..
    cp include/error_msg.hrl ../miniprogram/pet/error_msg/
    cp protobuffs/proto/*.proto ../miniprogram/pet/proto/
    echo 复制完成
}
...
fun_help(){
    echo "-create 编译proto"
    echo "-make 编译游戏"
    echo "-sync_proto 同步proto到miniprogram"
    echo "-start 启动游戏"
